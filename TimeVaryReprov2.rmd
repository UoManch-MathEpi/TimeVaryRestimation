...
This file creates the figures from Pang *et al* 2024 [Pang](https://www.medrxiv.org/content/10.1101/2024.03.26.24304928v1) (subject to random seed). 
...
incubation <- 3
infecitous <- 5
SimDat <- seir_tau_tv(MaxTime=10*400,dt=1/10, repro=2*log(2),sig=1/incubation, gam= 1/infecitous, N0=10^5, I0=10,E0=0, 
...
```{r}
PredMort$REdeath <- 1+infecitous*incubation*PredMort$sdt2+infecitous*incubation*PredMort$sdt^2+(incubation+infecitous)*PredMort$sdt
