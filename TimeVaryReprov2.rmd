...
```{r}
par(mfrow=c(2,2))
plot(PredMort$sdt, main='First derivative of spline', ylab='', xlab='Time')
plot(PredMort$sdt2, main='Second derivative of spline', ylab='', xlab='Time')
plot(PredMort$sdt3, main='Third derivative of spline', ylab='', xlab='Time')

plot(PredMort$time, 1+5*3*PredMort$sdt2+5*3*PredMort$sdt^2+(3+5)*PredMort$sdt, main='R estimate from death data', type='l', ylim=c(0,2), ylab='RE', xlab='Time')
abline(h=2*log(2))
```